      ...
      cursor_{fcppt::optional::map(
          ...
          [](fcppt::reference<awl::cursor::object const> const _cursor)
          {
            return fcppt::optional::to_exception(
                fcppt::cast::dynamic<awl::backends::sdl::cursor::object const>(_cursor.get()),
                []
                {
          ...
          fcppt::optional::maybe(
              ...
              [](fcppt::string const &_title)
              {
                return fcppt::optional::from(
                    fcppt::to_std_string(_title), [] { return std::string{"Invalid title"}; });
              })
              .c_str(),
          SDL_WINDOWPOS_UNDEFINED, //NOLINT(hicpp-signed-bitwise)
          SDL_WINDOWPOS_UNDEFINED, //NOLINT(hicpp-signed-bitwise)
          fcppt::cast::to_signed(fcppt::optional::maybe(
              _parameters.size(),
              []
              {
                constexpr const unsigned default_width{1024U};

                return default_width;
              },
              [](awl::window::dim const &_dim) { return _dim.w(); })),
          fcppt::cast::to_signed(fcppt::optional::maybe(
              _parameters.size(),
              []
              {
                constexpr const unsigned default_height{768U};

                return default_height;
              },
              [](awl::window::dim const &_dim) { return _dim.h(); })),
              ...
              SDL_WINDOW_HIDDEN | SDL_WINDOW_RESIZABLE)}
{
  awl::backends::sdl::window::set_object(
      this->impl_.get(),
      fcppt::reference_to_base<awl::backends::sdl::window::object>(fcppt::make_ref(*this)));
}

awl::backends::sdl::window::original_object::~original_object() = default;
...
awl::visual::object const &awl::backends::sdl::window::original_object::visual() const
{
  return this->visual_;
}

void awl::backends::sdl::window::original_object::set_cursor()
{
  fcppt::optional::maybe_void(
      this->cursor_,
      [](fcppt::reference<awl::backends::sdl::cursor::object const> const _cursor)
      {
        fcppt::optional::maybe(
            _cursor.get().get(),
            [] { SDL_ShowCursor(0); },
            [](fcppt::reference<SDL_Cursor> const _sdl_cursor)
            {
              SDL_ShowCursor(1);

              SDL_SetCursor(&_sdl_cursor.get());
            });
      });
}
