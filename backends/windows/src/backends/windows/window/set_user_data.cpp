...
void awl::backends::windows::window::set_user_data(
    HWND const _hwnd, awl::backends::windows::window::user_data const &_data)
{
  awl::backends::windows::window::set_long_ptr(
      _hwnd, GWLP_USERDATA, reinterpret_cast<LONG_PTR>(&_data));
}
