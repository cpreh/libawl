...
awl::backends::wayland::system::event::base::base(
    ...
    : awl::event::base{}, display_{_display}
{
}

awl::backends::wayland::system::event::base::~base() = default;

awl::backends::wayland::display &awl::backends::wayland::system::event::base::display() const
{
  return display_.get();
}
