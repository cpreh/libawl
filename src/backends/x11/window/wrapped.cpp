...
awl::backends::x11::window::wrapped::screen() const
{
	return
		screen_;
}
...
awl::backends::x11::window::wrapped::x11_visual() const
{
	return
		*visual_;
}
...
awl::backends::x11::window::wrapped::rect() const
{
	return
...
Window
awl::backends::x11::window::wrapped::get() const
{
	return
		window_;
}
